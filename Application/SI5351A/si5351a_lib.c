...
{
	return SI5351A_SetFreqHz(SI5351Ax,clkChannel,freq);
}
...
{
	return SI5351A_SetFreqKHz(SI5351Ax, clkChannel, freqKHz);
}
...
{
	return SI5351A_SetFreqMHz(SI5351Ax, clkChannel, freqMHz);
}