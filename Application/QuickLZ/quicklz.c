...
//===变量定义
//---压缩变量
qlz_state_compress g_glzStateCompress;
//---解压变量
qlz_state_decompress g_glzStateDecompress;
...
//////说	   明：
//////////////////////////////////////////////////////////////////////////////
static  ui32 fast_read( void const *src , ui32 bytes )
{
	#ifndef X86X64
...
//////说	   明：
//////////////////////////////////////////////////////////////////////////////
static  ui32 hashat( const unsigned char *src )
{
	ui32 fetch , hash;
...
//////说	   明：
//////////////////////////////////////////////////////////////////////////////
static  void fast_write( ui32 f , void *dst , size_t bytes )
{
	#ifndef X86X64
...
//////说	   明：
//////////////////////////////////////////////////////////////////////////////
static  void memcpy_up( unsigned char *dst , const unsigned char *src , ui32 n )
{
...
//////说	   明：
//////////////////////////////////////////////////////////////////////////////
static  void update_hash( qlz_state_decompress *state , const unsigned char *s )
{
	#if QLZ_COMPRESSION_LEVEL == 1
		ui32 hash;
		hash = hashat( s );
